...
function printGadgetSpecs(gadget) {
  return `Gadget Specs: Name: ${gadget.name}, Battery Life: ${gadget.batteryLife}, Wireless: ${gadget.isWireless}`
}
...
const garden = {
  plants: ["sunflower", "tomato", "potato"],
...
function problem6() {
  ...
  let result = `<strong>Playlist: KISS OF LIFE </strong><ul>`;
